const layoutFields = [
  // Póliza
  { k: 'DatDocumentos.TipoDocto', d: 'Tipo Documento', section: 'Póliza', display: { section: 'Datos de la póliza', subgroup: 'Identificación del documento', order: 22, span: 1, availability: 'printed' } },
  { k: 'DatDocumentos.Documento', d: 'Documento', section: 'Póliza', display: { section: 'Datos de la póliza', subgroup: 'Identificación del documento', order: 23, span: 1, availability: 'printed' } },
  ...
  { k: 'DatDocumentos.FDesde', d: 'Inicio de Vigencia', section: 'Póliza', display: { section: 'Datos de la póliza', subgroup: 'Vigencia', order: 24, span: 1, availability: 'printed' } },
  { k: 'DatDocumentos.FHasta', d: 'Fin de Vigencia', section: 'Póliza', display: { section: 'Datos de la póliza', subgroup: 'Vigencia', order: 25, span: 1, availability: 'printed' } },
  ...
  // Asegurado
  { k: 'DatDoctoDetail.IDAseg', d: 'Nombre', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Identificación del asegurado', order: 26, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirCalle', d: 'Calle', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 27, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirNumExt', d: 'Num ext.', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 28, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirNumInt', d: 'Num int.', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 29, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirCP', d: 'Código postal', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 34, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirColonia', d: 'Colonia', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 30, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirDelegacion', d: 'Delegación', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 32, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirEstado', d: 'Estado', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 33, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirCiudad', d: 'Ciudad', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 31, span: 1, availability: 'printed' } },
  { k: 'DatDoctoDetail.IDDirPais', d: 'País', section: 'Asegurado', display: { section: 'Datos del asegurado', subgroup: 'Domicilio del asegurado', order: 35, span: 1, availability: 'printed' } },
