...
La versión React + TypeScript + MySQL con el header `id: ClickIA` en `Buscar_Ejecutivos` y `auth_token_bi` desde `AutorizaId/Token/generar` quedó publicada como `v0.0.27`.
